...
@section('title','MitaPeng - Progress Mitra')
...
<h3 class="text-bold text-center mt-3">RINGKASAN LAPORAN PERORANGAN </h2>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center" style="width: 14%;"><?= $row->kode_tim ?></td>
